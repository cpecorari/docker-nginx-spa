[![docker pull cpecorari/nginx-spa][image shield]][docker hub]
...
## Forked from socialengine/nginx-spa
Thanks for his work, just needed ARM build for Raspberry, and now have my own fork to play :)
Feel free to do the same, open code !
...
$ docker run -e RAVEN_DSN=yourkey -e API_URL=http://myapi.example.com  \
  -e CONFIG_VARS=API_URL,RAVEN_DSN -p 8000:80 cpecorari/nginx-spa:arm-latest
...
[latest]: https://github.com/cpecorari/docker-nginx-spa/blob/master/Dockerfile
[base image]: https://github.com/nginxinc/docker-nginx
[image shield]: https://img.shields.io/badge/dockerhub-cpecorari%2Fnginx--spa-blue.svg
[docker hub]: https://registry.hub.docker.com/u/cpecorari/nginx-spa/
